...
APK_NAME = "vulkanComputeparticles"
SHADER_DIR = "computeparticles"
ASSETS_TEXTURES = ["particle01_rgba.ktx", "particle_gradient_rgba.ktx"]
...
if subprocess.call("ndk-build", shell=True) == 0:   
    ...
    os.makedirs("./assets/textures/%s" % SHADER_DIR, exist_ok=True)    
